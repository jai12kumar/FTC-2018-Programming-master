...
// Almost equivalent to StatesRedRight
@Autonomous
public class StatesBlueLeft extends AutoBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(redReading > blueReading ) {
            // We're blue, so go backwards to knock off the red jewel (red is backwards).
            driveDistance = 3;
        }
        else {
            // We're blue, so go forwards to knock off the red jewel (red is forwards).
            driveDistance = -3;
        }
